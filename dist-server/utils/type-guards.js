...
exports.isNodeBlockType = isNodeBlockType;
exports.isPosition = isPosition;
exports.isNodeBlock = isNodeBlock;
 ...
 * @public
 */
function isNodeBlockType(value) {
...
class Validator {
    constructor(correlationId) {
        this.errorFactory = new errors_js_1.ErrorFactory(correlationId);
    }
    /**
