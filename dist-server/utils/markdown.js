...
exports.markdownProcessor = exports.MarkdownProcessor = void 0;
...
class MarkdownProcessor {
    constructor() {
        this.logger = new logger_js_1.Logger('MarkdownProcessor');
    }
    /**
    ...
    highlightCodeBlocks(element) {
        ...
        try {
            ...
            this.logger.logError(error, 'highlightCodeBlocks', {
                elementId: element.id || 'unnamed'
            });
        }
    }
...
exports.markdownProcessor = new MarkdownProcessor();
