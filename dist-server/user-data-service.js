...
class UserDataService {
    constructor() {
        ...
        this.validator = new type_guards_1.Validator();
    ...
    async loadUserFile(userId, fileName) {
        ...
        try {
            ...
            this.logger.logError('Failed to load user file', error);
            if (error instanceof UserDataError) {
                throw error;
            }
    ...
    async updateUserFile(userId, fileId, request) {
        ...
        try {
            ...
            this.logger.logError('Failed to update user file', error);
            if (error instanceof UserDataError) {
                throw error;
            }
    ...
    async deleteUserFile(userId, fileId) {
        ...
        try {
            ...
            this.logger.logError('Failed to delete user file', error);
            if (error instanceof UserDataError) {
                throw error;
            }
    ...
    async getOrCreateDefaultFile(userId) {
        ...
        try {
            ...
            this.logger.logError('Failed to get or create default file', error);
