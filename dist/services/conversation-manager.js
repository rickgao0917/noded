...
import { DEFAULT_ASSOCIATION_RULES } from '../types/conversation.types.js';
/**
...
export class ConversationManager {
     ...
     */
    buildThreadFromNodeToRoot(nodeId) {
        ...
        try {
            ...
            if (!targetNode) {
                throw this.errorFactory.createValidationError(`Node with ID ${nodeId} not found`, 'NODE_NOT_FOUND', 'The selected node does not exist.', 'buildThreadFromNodeToRoot', { nodeId });
            }
            ...
            while (currentNode) {
                ...
                if (currentNode.parentId) {
                    ...
                    if (!currentNode && nodePath.length > 1) {
                        ...
                        throw this.errorFactory.createTreeStructureError('Broken parent reference in conversation thread', 'BROKEN_PARENT_REF', 'The conversation thread is incomplete due to missing nodes.', 'buildThreadFromNodeToRoot', { brokenAt: nodePath[0], parentId: targetNode.parentId });
                    }
                }
                else {
            ...
            this.logger.logError(error, 'buildThreadFromNodeToRoot', { nodeId });
            throw error;
        }
    }
    /**
     ...
     */
    submitPromptForNode(nodeId, promptContent, onStreamingUpdate) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!currentNode) {
                    throw this.errorFactory.createValidationError(`Node with ID ${nodeId} not found`, 'NODE_NOT_FOUND', 'Cannot submit prompt: node does not exist.', 'submitPromptForNode', { nodeId });
                }
                ...
                if (promptBlock && promptBlock.content === '') {
                    ...
                    yield this.graphEditor.submitToLLM(nodeId, onStreamingUpdate);
                    // Update flow state
                    ...
                    return yield this.createChildNodeForPrompt(nodeId, promptContent, onStreamingUpdate);
                }
            }
            catch (error) {
                this.logger.logError(error, 'submitPromptForNode');
                throw error;
            }
            finally {
                const executionTime = performance.now() - startTime;
     ...
     */
    createChildNodeForPrompt(parentNodeId, promptContent, onStreamingUpdate) {
        return __awaiter(this, void 0, void 0, function* () {
            const startTime = performance.now();
            ...
            try {
                ...
                if (!parentNode) {
                    throw this.errorFactory.createValidationError(`Parent node with ID ${parentNodeId} not found`, 'PARENT_NOT_FOUND', 'Cannot create child node: parent does not exist.', 'createChildNodeForPrompt', { parentNodeId });
                }
                ...
                try {
                    ...
                    this.logger.logError(error, 'createChildNodeForPrompt', {
                        phase: 'node_creation'
                    });
                    throw error;
                }
                ...
                try {
                    ...
                    yield this.graphEditor.submitToLLM(newNodeId, onStreamingUpdate);
                    // Update flow state
     ...
     */
    associateMarkdownWithPreviousPrompt(markdownContent, currentThread) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const startTime = performance.now();
            ...
            try {
                ...
                if (!promptNodeId) {
                    throw this.errorFactory.createValidationError('No previous prompt found to associate markdown with', 'NO_PREVIOUS_PROMPT', 'You must send a prompt before adding markdown notes.', 'associateMarkdownWithPreviousPrompt', { threadId: currentThread.id });
                }
                ...
                try {
                    ...
                    if (node) {
                        ...
                        if (lastMarkdownBlock) {
                            ...
                            if (blockIndex !== -1) {
                                ...
                                if (previewManager) {
                                    try {
                                        yield previewManager.setBlockPreviewMode(lastMarkdownBlock.id, // BlockId type
                                        'rendered', 'api');
                                    }
                                    catch (error) {
                                ...
                                this.logger.logInfo('Markdown block added and updated', 'associateMarkdownWithPreviousPrompt', {
                                    ...
                                    blockId: lastMarkdownBlock.id,
                                    blockIndex,
                                    finalContent: (_b = (_a = this.graphEditor.getNode(promptNodeId)) === null || _a === void 0 ? void 0 : _a.blocks[blockIndex]) === null || _b === void 0 ? void 0 : _b.content
                                });
                            }
                        }
                    }
                    ...
                    this.logger.logError(error, 'associateMarkdownWithPreviousPrompt', {
     ...
     */
    getFlowState() {
        return Object.assign({}, this.flowState);
    }
    /**
     ...
     */
    buildConversationContext(thread) {
        const contextParts = [];
